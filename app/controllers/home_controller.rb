class HomeController < ApplicationController
  ...
  def guide
    @meta = {
      'title' => 'ご利用ガイド',
      'description' => 'DMM 農機のご利用ガイドです。在庫の見つけにくい中古農機具をはじめとして、農業生産に必要となるあらゆる機械、農機具を掲載している、中古農機具販売サービスです。お客様のご要望に応じてDMM 農機が仕入れ、販売、納品、メンテナンスまで一貫して対応いたします。'
    }
  end
  ...
  def commercial
    @meta = {
      ...
      'description' => 'DMM 農機の特定商取引法及び古物営業法に基づく表記について。在庫の見つけにくい中古農機具をはじめとして、農業生産に必要となるあらゆる機械、農機具を掲載している、中古農機具販売サービスです。お客様のご要望に応じてDMM 農機が仕入れ、販売、納品、メンテナンスまで一貫して対応いたします。'
    }
  end
